...
namespace ProgrammersBlog.Mvc.Helpers.Concrete
{
    public class ImageHelper : IImageHelper
    {
        ...
        public async Task<IDataResult<ImageUploadedDto>> UploadUserImage(string userName, IFormFile pictureFile, string folderName = "userImages")
        {
            ...
            string oldFileName = Path.GetFileNameWithoutExtension(pictureFile.FileName); //Dosya adını extension olmadan aldık.
            string fileExtension = Path.GetExtension(pictureFile.FileName); //Uzantıyı aldık.
