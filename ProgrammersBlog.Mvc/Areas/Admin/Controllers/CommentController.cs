...
namespace ProgrammersBlog.Mvc.Areas.Admin.Controllers
{
    ...
    public class CommentController : BaseController
    {
        ...
        public async Task<JsonResult> UndoDelete(int commentId)
        {
            ...
            return Json(undoDeleteCommentResult, new JsonSerializerOptions()
            {
                ReferenceHandler = ReferenceHandler.Preserve
            });
        }
        ...
        public async Task<JsonResult> HardDelete(int commentId)
        {
            ...
            return Json(hardDeletedCommentResult, new JsonSerializerOptions() { ReferenceHandler = ReferenceHandler.Preserve });
        }
    }
}
