...
namespace ProgrammersBlog.Services.Concrete
{
    public class CategoryManager : ManagerBase, ICategoryService
    {
        ...
        public async Task<IDataResult<CategoryListDto>> GetAllAsync()
        {
            ...
            return new DataResult<CategoryListDto>(ResultStatus.Error, Messages.Category.NotFound(isPlural: true), new CategoryListDto() { Categories = null, Message = Messages.Category.NotFound(isPlural: true), ResultStatus = ResultStatus.Error });
        }

        public async Task<IDataResult<CategoryListDto>> GetAllAsyncByDeleted()
        {
        ...
        public async Task<IDataResult<CategoryListDto>> GetAllAsyncByNonDeleted()
        {
            var categories = await _unitOfWork.Categories.GetAllAsync(c => !c.IsDeleted);
            if (categories.Count > -1)
            {
        ...
        public async Task<IDataResult<CategoryListDto>> GetAllAsyncByNonDeletedAndActive()
        {
